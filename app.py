...
def model_prediction(image_path):
    model = tf.keras.models.load_model('Plant _disease_cnn_model.keras')
    ...
    app_model=st.sidebar.selectbox('Select page',['Home', 'Disease Recognition'])
    ...
    if(app_mode=='Home'):
        st.markdown("<h1 style='text-align: center;'>Plant Disease Prediction System for Sustainable Agriculture>",unsafe_allow_html=true)
